...
class TestBadRequestCase(TestElectionsCase):
    ...
    def test_office_less_keys(self):
        response = self.client.post('/api/v2/parties', data=json.dumps(self.office_less_keys), content_type='application/json')
        result = json.loads(response.data)
    ...
    def test_invalid_office_type(self):
        response = self.client.post('/api/v2/offices', data=json.dumps(self.invalid_office_type), content_type='application/json')
        result = json.loads(response.data)
    ...
    def test_legislative_mismatch_president(self):
        response = self.client.post('/api/v2/offices', data=json.dumps(self.legislative_mismatch_president), content_type='application/json')
        result = json.loads(response.data)
    ...
    def test_legislative_mismatch_prime_minister(self):
        response = self.client.post('/api/v2/offices', data=json.dumps(self.legislative_mismatch_prime_minister), content_type='application/json')
        result = json.loads(response.data)
        self.assertEqual(result['Error'], 'Only a Senator, Member of Parliament or a Women Rep can occupy a legislative office')
        self.assertEqual(response.status_code, 400)
        self.assertFalse('data' in result)
    ...
    def test_legislative_mismatch_governor(self):
        response = self.client.post('/api/v2/offices', data=json.dumps(self.legislative_mismatch_governor), content_type='application/json')
        result = json.loads(response.data)
        self.assertEqual(result['Error'], 'Only a Senator, Member of Parliament or a Women Rep can occupy a legislative office')
        self.assertEqual(response.status_code, 400)
        self.assertFalse('data' in result)
    ...
    def test_legislative_mismatch_mca(self):
        response = self.client.post('/api/v2/offices', data=json.dumps(self.legislative_mismatch_mca), content_type='application/json')
        result = json.loads(response.data)
        self.assertEqual(result['Error'], 'Only a Senator, Member of Parliament or a Women Rep can occupy a legislative office')
        self.assertEqual(response.status_code, 400)
        self.assertFalse('data' in result)
    ...
    def test_executive_mismatch_governor(self):
        response = self.client.post('/api/v2/offices', data=json.dumps(self.executive_mismatch_governor), content_type='application/json')
        result = json.loads(response.data)
    ...
    def test_executive_mismatch_senator(self):
        response = self.client.post('/api/v2/offices', data=json.dumps(self.executive_mismatch_senator), content_type='application/json')
        result = json.loads(response.data)
        self.assertEqual(result['Error'], 'Only the President or the Prime Minister can occupy an executive office')
        self.assertEqual(response.status_code, 400)
        self.assertFalse('data' in result)
    ...
    def test_executive_mismatch_mp(self):
        response = self.client.post('/api/v2/offices', data=json.dumps(self.executive_mismatch_mp), content_type='application/json')
        result = json.loads(response.data)
        self.assertEqual(result['Error'], 'Only the President or the Prime Minister can occupy an executive office')
        self.assertEqual(response.status_code, 400)
        self.assertFalse('data' in result)
    ...
    def test_executive_mismatch_women_rep(self):
        response = self.client.post('/api/v2/offices', data=json.dumps(self.executive_mismatch_women_rep), content_type='application/json')
        result = json.loads(response.data)
        self.assertEqual(result['Error'], 'Only the President or the Prime Minister can occupy an executive office')
        self.assertEqual(response.status_code, 400)
        self.assertFalse('data' in result)
    ...
    def test_executive_mismatch_mca(self):
        response = self.client.post('/api/v2/offices', data=json.dumps(self.executive_mismatch_mca), content_type='application/json')
        result = json.loads(response.data)
        self.assertEqual(result['Error'], 'Only the President or the Prime Minister can occupy an executive office')
        self.assertEqual(response.status_code, 400)
        self.assertFalse('data' in result)
    ...
    def test_county_mismatch_president(self):
        response = self.client.post('/api/v2/offices', data=json.dumps(self.county_mismatch_president), content_type='application/json')
        result = json.loads(response.data)
    ...
    def test_county_mismatch_prime_minister(self):
        response = self.client.post('/api/v2/offices', data=json.dumps(self.county_mismatch_prime_minister), content_type='application/json')
        result = json.loads(response.data)
        self.assertEqual(result['Error'], 'Only a Governor or an MCA can occupy a county office')
        self.assertEqual(response.status_code, 400)
        self.assertFalse('data' in result)
    ...
    def test_county_mismatch_senator(self):
        response = self.client.post('/api/v2/offices', data=json.dumps(self.county_mismatch_senator), content_type='application/json')
        result = json.loads(response.data)
        self.assertEqual(result['Error'], 'Only a Governor or an MCA can occupy a county office')
        self.assertEqual(response.status_code, 400)
        self.assertFalse('data' in result)
    ...
    def test_county_mismatch_mp(self):
        response = self.client.post('/api/v2/offices', data=json.dumps(self.county_mismatch_mp), content_type='application/json')
        result = json.loads(response.data)
        self.assertEqual(result['Error'], 'Only a Governor or an MCA can occupy a county office')
        self.assertEqual(response.status_code, 400)
        self.assertFalse('data' in result)
    ...
    def test_county_mismatch_women_rep(self):
        response = self.client.post('/api/v2/offices', data=json.dumps(self.county_mismatch_women_rep), content_type='application/json')
        result = json.loads(response.data)
        self.assertEqual(result['Error'], 'Only a Governor or an MCA can occupy a county office')
        self.assertEqual(response.status_code, 400)
        self.assertFalse('data' in result)
...
class TestNotFoundCase(TestElectionsCase):
    ...
    def test_get_specific_office_invalid_id(self):
        ...
        response = self.client.get('/api/v2/offices/106', data=json.dumps(self.office), content_type='application/json')
        result = json.loads(response.data)
