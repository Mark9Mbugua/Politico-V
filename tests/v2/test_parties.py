...
class TestBadRequestCase(TestElectionsCase):
    ...
    def test_party_less_keys(self):
        response = self.client.post('/api/v2/parties', data=json.dumps(self.party_less_keys), content_type='application/json')
        result = json.loads(response.data)
    ...
    def test_hq_add_no_str(self):
        response = self.client.post('/api/v2/parties', data=json.dumps(self.hq_add_no_str), content_type='application/json')
        result = json.loads(response.data)
    ...
    def test_party_name_blank(self):
        response = self.client.post('/api/v2/parties', data=json.dumps(self.party_name_blank), content_type='application/json')
        result = json.loads(response.data)
    ...
    def test_hqAddress_blank(self):
        response = self.client.post('/api/v2/parties', data=json.dumps(self.hqAddress_blank), content_type='application/json')
        result = json.loads(response.data)
    ...
    def test_logoUrl_blank(self):
        response = self.client.post('/api/v2/parties', data=json.dumps(self.logoUrl_blank), content_type='application/json')
        result = json.loads(response.data)
    ...
    def test_logoUrl_no_scheme(self):
        ...
        response = self.client.post('/api/v2/parties', data=json.dumps(self.logoUrl_no_scheme), content_type='application/json')
        result = json.loads(response.data)
        self.assertEqual(result['Error'], "logoUrl should be in the format 'https://www.twitter.com/profile/img.jpg'")
        self.assertEqual(response.status_code, 400)
        self.assertFalse('data' in result)
    ...
    def test_logoUrl_no_netloc(self):
        ...
        response = self.client.post('/api/v2/parties', data=json.dumps(self.logoUrl_no_netloc), content_type='application/json')
        result = json.loads(response.data)
        self.assertEqual(result['Error'], "logoUrl should be in the format 'https://www.twitter.com/profile/img.jpg'")
        self.assertEqual(response.status_code, 400)
        self.assertFalse('data' in result)
    ...
    def test_logoUrl_no_path(self):
        ...
        response = self.client.post('/api/v2/parties', data=json.dumps(self.logoUrl_no_path), content_type='application/json')
        result = json.loads(response.data)
        self.assertEqual(result['Error'], "logoUrl should be in the format 'https://www.twitter.com/profile/img.jpg'")
        self.assertEqual(response.status_code, 400)
        self.assertFalse('data' in result)
    ...
    def test_edit_party_no_name_key(self):
        response = self.client.post('/api/v2/parties', data=json.dumps(self.edit_party_no_name_key), content_type='application/json')
        result = json.loads(response.data)
        response = self.client.patch('/api/v2/parties/1', data=json.dumps(self.edit_party_no_name_key), content_type='application/json')
        result = json.loads(response.data)
    ...
    def test_edit_party_name_blank(self):
        response = self.client.post('/api/v2/parties', data=json.dumps(self.party), content_type='application/json')
        result = json.loads(response.data)
        response = self.client.patch('/api/v2/parties/1', data=json.dumps(self.party_name_blank), content_type='application/json')
        result = json.loads(response.data)
        self.assertEqual(result['Error'], 'Party name is required')
        self.assertEqual(response.status_code, 400)
        self.assertFalse('data' in result)
    ...
    def test_edit_party_name_not_purely_alpha_and_space(self):
        response = self.client.post('/api/v2/parties', data=json.dumps(self.party), content_type='application/json')
        result = json.loads(response.data)
        response = self.client.patch('/api/v2/parties/1', data=json.dumps(self.party_name_not_purely_alpha_and_space), content_type='application/json')
        result = json.loads(response.data)
...
class TestNotFoundCase(TestElectionsCase):
    ...
    def test_get_specific_party_invalid_id(self):
        ...
        response = self.client.get('/api/v2/parties/300', data=json.dumps(self.party), content_type='application/json')
        result = json.loads(response.data)
    ...
    def test_delete_specific_party_invalid_id(self):
        ...
        response = self.client.delete('/api/v2/parties/106', data=json.dumps(self.party), content_type='application/json')
        result = json.loads(response.data)
        self.assertEqual(result['Error'], 'Political party cannot be found')
        self.assertEqual(response.status_code, 404)
        self.assertFalse('data' in result)
    ...
    def test_patch_invalid_party_id(self):
        response = self.client.post('/api/v2/parties', data=json.dumps(self.party), content_type='application/json')
        result = json.loads(response.data)
        response = self.client.patch('/api/v2/parties/3000', data=json.dumps(self.party), content_type='application/json')
        result = json.loads(response.data)
        self.assertEqual(result['Error'], 'Political party cannot be found')
        self.assertEqual(response.status_code, 404)
        self.assertFalse('data' in result)
